...
<body>
	...
	<?php include "header.php"; ?>
		<div class="intro">
			...
			Läs mer om regler och priserna här. Lycka till!</p>
			...
			<ul class="steps clearfix">
				...
				<li><span class="number">3</span><span class="description"><h6>Tagga</h6><p>Tagga bilden med: #nackaforummatochvin</p></span></li>
