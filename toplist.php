...
<nav class="main-navigation">
	<ul>
		...
		<li><a href="toplist.php" class="active">TOPPLISTA</a></li>
...
<div class="all">
	<div class="sub-intro">
		<h1>Topplista</h1>
		<p>Här ser du de bidrag som leder tävlingen. Var med och tävla du också och ta chansen att vinna en lyxig matkasse värd 1200 kr utvald av kocken Tommy Myllymäki</p>
	...
	<div class="latest">
		...
		<?php 
			...
			$query = 'SELECT * from imgs ORDER BY votes DESC LIMIT 9';
